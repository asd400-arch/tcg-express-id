    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '40px 20px 80px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '32px', border: '1px solid #f1f5f9', marginTop: '20px' }}>
          ...
          <p style={p}>Tech Chain Global Pte Ltd ("TCG", "we", "us") is committed to protecting the personal data of our users in accordance with the Undang-Undang Perlindungan Data Pribadi ("UU PDP") of Indonesia. This Privacy Policy explains how we collect, use, disclose, and protect your personal data when you use the TCG Express platform ("Platform").</p>
          ...
          <p style={p}>Driving licence details, vehicle type and plate number, bank account details for payouts.</p>
          ...
          <p style={p}>We retain your personal data for as long as your account is active and for a reasonable period thereafter for legal, tax, and audit purposes. Transaction records are retained for a minimum of 5 years as required by Indonesian regulations. Location data from completed deliveries is retained for 90 days, then anonymised.</p>
          ...
          <h2 style={h2}>7. Your Rights Under UU PDP</h2>
          <p style={p}>Under the UU PDP, you have the right to:</p>
          ...
          <p style={p}>Your data may be processed on servers located outside of Indonesia (e.g., cloud hosting providers). Where such transfers occur, we ensure appropriate safeguards are in place to protect your data in accordance with the UU PDP.</p>
          ...
          <p style={p}>If you are not satisfied with our response, you may lodge a complaint with the Kementerian Komunikasi dan Digital (Komdigi) of Indonesia.</p>
        </div>
      </div>
    </div>
  );
